...
{
	public sealed class CentimeterCubedJsonConverter : JsonConverter<CentimeterCubed>
	{
		public override CentimeterCubed Read(
			...
			JsonSerializerOptions options)
		{
			...
			return new CentimeterCubed(xvalue, yvalue, zvalue);
		}

		public override void Write(
			Utf8JsonWriter writer,
			CentimeterCubed unit,
			JsonSerializerOptions options)
		{
