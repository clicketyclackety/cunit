	...
	public sealed class UniversalConverter : JsonConverter<IUnit>
	{
			...
			JsonSerializerOptions options)
		{
			try
			{
				...
				dynamic foundUnit = symbol switch
				{
					...
					Yard.Symbol => new Yard(dimensionValues[0]),
					YardSquared.Symbol => new YardSquared(dimensionValues[0], dimensionValues[1]),
					YardCubed.Symbol => new YardCubed(dimensionValues[0], dimensionValues[1], dimensionValues[2]),
					Mile.Symbol => new Mile(dimensionValues[0]),
					MileSquared.Symbol => new MileSquared(dimensionValues[0], dimensionValues[1]),
					MileCubed.Symbol => new MileCubed(dimensionValues[0], dimensionValues[1], dimensionValues[2]),
				...
				return typeToConvert.Name switch
				{
					...
					nameof(Yard) => (Yard)foundUnit,
					nameof(YardSquared) => (YardSquared)foundUnit,
					nameof(YardCubed) => (YardCubed)foundUnit,
					nameof(Mile) => (Mile)foundUnit,
					nameof(MileSquared) => (MileSquared)foundUnit,
					nameof(MileCubed) => (MileCubed)foundUnit,
			...
			JsonSerializerOptions options)
		{
			string symbol = unit switch
			{
				...
				Yard => Yard.Symbol,
				YardSquared => YardSquared.Symbol,
				YardCubed => YardCubed.Symbol,
				Mile => Mile.Symbol,
				MileSquared => MileSquared.Symbol,
				MileCubed => MileCubed.Symbol,
