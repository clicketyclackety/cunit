...
{
	public sealed class KilometerCubedJsonConverter : JsonConverter<KilometerCubed>
	{
		public override KilometerCubed Read(
			...
			JsonSerializerOptions options)
		{
			...
			return new KilometerCubed(xvalue, yvalue, zvalue);
		}
